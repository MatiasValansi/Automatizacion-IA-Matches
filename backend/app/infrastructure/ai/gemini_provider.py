...
class GeminiAIProvider(AIProvider):
    ...
    def build_system_prompt() -> str:
        return (
            ...
            "Cada fila DENTRO de la tabla tiene un nombre y DOS COLUMNAS de casillas a la derecha:\n"
            "- La PRIMERA columna (izquierda) es SI.\n"
            "- La SEGUNDA columna (derecha) es NO.\n\n"
            "Prestá especial atención a los trazos de birome dentro de los cuadrados. "
            "Si hay CUALQUIER marca, tilde, cruz o trazo en la primera columna, es interested: true. "
            "Si la marca está en la segunda columna, es interested: false.\n\n"
            "- Transcribí cada nombre EXACTAMENTE como está escrito (nombre y apellido completos).\n\n"
            "### REGLA DE ORO:\n"
            "Si el dueño de la planilla votó a alguien pero NO marcó ni SI ni NO en ninguna columna, "
            "asumí interested: false por defecto. Es preferible un falso negativo a un falso positivo.\n\n"
            "### REGLAS GENERALES:\n"
